...
Insertion.queryData = function(query, callback) {
...
Insertion.insertRecord = function(recordIn ,callback){
...
Insertion.insertRecordArray = function(records, callback){
    var docs = [];
...
Insertion.insertFile = function(){};
Insertion.insertFileArray = function(){};

Insertion.updateData = function(query, update, callback){
    client.connect(this.url, function (err, db){
        if(err) { callback(err); return; }
        var col = db.collection(collection);
